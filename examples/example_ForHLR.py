        ...
        if subshowers==0:
            ...
            ##save ANTENNA POSITIONS in anpos.dat for each event
                ...
                if UPLOAD==1:
                    ...
                    folderiRod=join("grand/sim",run,"output_fh1_fix", folder1, folder2, folder3,  folder4) 
                    #print folderiRod
                    
                    # creating directories. This is blocking until it succeeds.
                    # It will retry at most 5 times and will wait 6s between trials.
                    try:
                        irods_retry(irods_makedirs, 5, 6., "grand/sim",run,"output_fh1_fix", folder1, folder2, folder3,  folder4)
                    except:
